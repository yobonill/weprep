<?php  
    ...
    //Call the function for deleting the product if it is admin
		if (isAdmin()) {
            $id = $_GET['id'];
            delete_product($id);
		} else {
	...
	//Return the user to the adminproducts page
		header("Location: ../../?view=adminproducts&msj=productdeleted");
	//Return the user to the adminproducts page
?>