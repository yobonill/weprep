	...
	<div class="container center">
		...
		<div class="row">
			<?php //if (isDispatcher()): ?>
				...
				<div class="col-md-6 col-xs-12">
					<a href="?view=reports"><button type="button" class="btn btn-primary personal-btn"><i class="fa fa-book personal-fa" aria-hidden="true"> </i> <br><?= $language["__BUTTON2__"]?></button></a>
				</div>
			<?php //endif ?>	
		</div>
	</div>
